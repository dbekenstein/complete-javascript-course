...
const boardPassengers = function (n, wait) {
  ...
  // timer - after 1000 ms, call the function
  setTimeout(function () {
  ...
  // Will start boarding in ${wait seconds}
  // Delay of wait * 1000
  // CL of setTimeout function
};
// this will not be used, it will prioritize the variable inside the function.
